...
import { Table, Button, Tag, Tooltip, Tabs, message, Modal, Card, Badge } from 'antd';
import {
  ReloadOutlined,
  CopyOutlined,
  EyeOutlined,
        ...
        {currentNode && (
          <div>
            <Card title="基本信息" style={{ marginBottom: 16 }}>
              ...
              <p><strong>下载速度:</strong> {currentNode.download_speed ? `${currentNode.download_speed}KB/s` : '-'}</p>
              <p><strong>上传速度:</strong> {currentNode.upload_speed ? `${currentNode.upload_speed}KB/s` : '-'}</p>
            ...
            <Card title="历史记录">
              <Table
                columns={[
                  ...
                  { title: '下载速度', dataIndex: 'download_speed', key: 'download_speed', render: (speed) => speed ? `${speed}KB/s` : '-' },
                  { title: '上传速度', dataIndex: 'upload_speed', key: 'upload_speed', render: (speed) => speed ? `${speed}KB/s` : '-' },
                ]}
