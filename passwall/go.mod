...
require (
	MediaUnlockTest v0.0.0-00010101000000-000000000000
	github.com/faceair/clash-speedtest v1.7.0
...
replace MediaUnlockTest => github.com/HsukqiLee/MediaUnlockTest v1.8.3-1755936179
