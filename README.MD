...
database:
  driver: "postgres"
  dsn: "host=localhost user=passwall password=passwall port=5432 dbname=passwall sslmode=disable TimeZone=Asia/Shanghai"  # 按实际情况调整
...
https://github.com/HsukqiLee/MediaUnlockTest 提供的解锁测试能力
